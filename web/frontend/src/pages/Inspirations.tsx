...
export default function Inspirations(){
  ...
  const {data,loading,error,reload}=useLoad(()=>api.inspirations.list({trip_id:tripId}));const [tag,setTag]=useState('全部'),[editing,setEditing]=useState<Inspiration|null|undefined>(undefined),[params,setParams]=useSearchParams()
